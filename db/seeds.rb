...
puts 'User done, Questions seed started'
  ...
  Answer.create(question_id: general_question1.id, answer_content: "4")
  ...
  Answer.create(question_id: content_question4.id, answer_content: "5")
  ...
  Answer.create(question_id: body_language_question2.id, answer_content: "4")
  ...
  Answer.create(question_id: content_question2.id, answer_content: "3")
